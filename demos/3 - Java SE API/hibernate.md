# Hibernate
*This content is not a part of the Java EE curriculum; however, this should be useful for understanding how Spring framework helps to abstract away Hibernate in later weeks and may also be useful for Project 1.*
